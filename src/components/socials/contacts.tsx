...
const Contacts = (props: Props) => {
  ...
  const itemsToShow = showAll ? contacts : contacts.slice(0, 4)

  return (
    <div className='p-4'>
      <h1 className={cn(themeColor.color === 'light' ? 'text-black' : 'text-white')}>Contact Links</h1>
